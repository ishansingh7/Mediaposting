        ...
        <div className="flex items-center gap-2">
          {isAdmin ? (
            <button
              ...
              className="hidden items-center gap-2 rounded-full bg-ember px-4 py-2 text-sm font-extrabold text-white shadow-glow transition hover:-translate-y-0.5 xl:flex"
            >
              <Plus size={17} />
              Create Post
            </button>
